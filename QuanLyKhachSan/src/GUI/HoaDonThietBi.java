...
public class HoaDonThietBi extends javax.swing.JFrame {

    Vector title = new Vector();
    Vector data = new Vector();
    ArrayList<ChiTietSDThietBi> ds = CTSuDungThietBiDAO.getData();
    ...
    private void addTitle() {
        ...
        title.add("ID Thiết Bị");
        title.add("Ngày Thuê");
        title.add("Số Lượng");
        title.add("Tổng Tiền DV");
    }

    private void addData(ArrayList<ChiTietSDThietBi> ds) {
        data.removeAllElements();
        for (ChiTietSDThietBi c : ds) {
            Vector v = new Vector();
            v.add(c.getMahd());
            v.add(c.getMatb());
            v.add(c.getNgay());
    ...
    private void jComboBox2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox2ActionPerformed
        ...
        switch (jComboBox2.getSelectedIndex()) {
            case 0 -> {
                ...
                jTextPane1.setText("");
                ds = CTSuDungThietBiDAO.getData();
                addData(ds);
            }
            case 1 -> {
                lblTongDv.setText(String.valueOf(CTSuDungThietBiDAO.countHoaDonTheoThang(month)) + " dịch vụ");
                lblDoanhThuDv.setText(String.valueOf(df.format(CTSuDungThietBiDAO.sumTongTienDichVuTheoThang(month))) + " VNĐ");
                jTextPane1.setText("");
                ds = CTSuDungThietBiDAO.getDataTheoThang(month);
                addData(ds);
            }
            case 2 -> {
                lblTongDv.setText(String.valueOf(CTSuDungThietBiDAO.countHoaDonTheoThang(month)) + " dịch vụ");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String htmlContent = "<html>\n"
                ...
                + "		<h1 style=\"text-align: center;\">********** THỐNG KÊ HÓA ĐƠN THIẾT BỊ **********</h1>\n"
                + "    </div>\n"
                + "	<table>\n"
                + "		<tbody>\n"
                + "			<tr>\n"
        ...
        for (ChiTietSDThietBi dsct : ds) {
            htmlContent += "            <tr>\n"
                    + "                <td>" + dsct.getMahd().trim() + "</td>\n"
                    + "                <td>" + dsct.getMatb().trim() + "</td>\n"
        ...
        if (!(jComboBox2.getSelectedIndex() == 0)) {
            htmlContent += " </table>\n"
                    + "<br><br><strong>Tổng hóa đơn sử dụng thiết bị là: <b>" + lblTongDv.getText() + "</b></strong>"
                    + "<br><br><strong>Tổng doanh thu sử dụng thiết bị là: <b>" + lblDoanhThuDv.getText() + "</b></strong>"
                    + "<br><br><br><br>"
            ...
            htmlContent += " </table>\n"
                    + "<br><br><strong>Tổng hóa đơn sử dụng thiết bị là: <b>" + CTSuDungThietBiDAO.countHoaDon() + "</b></strong>"
                    + "<br><br><strong>Tổng doanh thu sử dụng thiết bị là: <b>" + df.format(CTSuDungThietBiDAO.sumTongTienDichVu()) + "</b></strong>"
                    + "<br><br><br><br>"
                    + "<div style=\"text-align: right;\">\n"
                    + "        <i style=\"text-align: right;\">TP.HCM, ngày " + day + " tháng " + month + " năm " + year + "</i>\n"
                    + "        <p>Ký tên</p><br><br><br><br><br><br>\n"
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HoaDonThietBi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HoaDonThietBi().setVisible(true);
            }
        });
    }
